...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler
{
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException ex,HttpHeaders headers, HttpStatus status, WebRequest request)
	{
		...
		String detail =  String.format("O parametro de URL '%s' recebeu valor '%s', que é de um tipo inválido. Corrija e informe um valor compativel com o tipo '%s'.", ex.getName(), ex.getValue(), ex.getRequiredType().getSimpleName());
			...
			WebRequest request) 
	{
		...
		String detail = String.format("A propriedade '%s' não existe. Corrija ou remova essa propriedade", path);
